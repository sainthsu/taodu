<div class="body {if $cat==1}fatBody{elseif $cat==2}momBody{elseif $cat==3}weddingBody{/if}">
 {include file="header.tpl"}

 <!--main开始-->

 <div class="special" style="margin-top: 150px;">
...
$(document).ready(function(){
 ...
 <div class="fashion">
   ...
   <div class="hei_pica" style="height:290px;margin-left:0px;{if ($i+1)%4!=0}margin-right:9px;{/if}margin-top:10px;">
	  <div class="bigmg_a"><a href="http://item.taobao.com/item.htm?id={$p.iid}" target="_blank"><img data-ks-lazyload="{$p.pic}"></a></div>
	  <div class="bigmg_b">
