	...
	<table class="data">
		<tbody>
			<tr>
				...
				<td><input type="text" name="src" class="t" value="{$adinfo.pic}" /></td>
				<td class="left">其他：</td>
			...
			<tr>
				...
				<td><input type="text" name="link" class="t" value="{$adinfo.link}" /></td>
				<td class="left">排序：</td>
				<td><input type="text" name="rank" value="{if $adinfo.rank}{$adinfo.rank}{else}10{/if}" /></td>
			</tr>
			<tr>
				<td class="left">开始日期：</td>
				<td><input type="text" name="st"  class="kg_datePicker ad_et" data-config='{"isHoliday": false,
                           "minDate" :"2013-08-09","finalTriggerNode" : "kg_datePicker_final", "finalTriggerMinDate" : "2013-08-10"}' value="{$adinfo.start_time}" /></td>
				<td class="left">结束日期：</td>
				<td><input type="text" name="et"  class="kg_datePicker ad_et" data-config='{"isHoliday": false,
                           "minDate" :"2013-08-09","finalTriggerNode" : "kg_datePicker_final", "finalTriggerMinDate" : "2013-08-10"}' value="{$adinfo.end_time}" /></td>
			</tr>
			<tr>
				<td class="left">标题：</td>
				<td><input type="text" name="title" class="t" value="{$adinfo.title}" /></td>
				<td class="left">备注：</td>
				<td><input type="text" name="remark" value="{$adinfo.remark}" /> </td>
			</tr>
			<tr>
				<td class="left">类目：</td>
				<td colspan="3">
