...
var dots = DOM.query(".ex_dot");
var exPro = DOM.query(".ex_pro")[0];
for(var i=0;i<3;i++)
{
	var dot = dots[i];
	Event.on(dot,"click",function()
	{
		$(".ex_dot").removeClass("dot_seleted");
		var left = DOM.attr(this,"data-id")*(-229);
console.log(exPro);
		DOM.addClass(this,"dot_seleted")
		Anim(exPro,{marginLeft:left+"px"},0.3).run();
	});
}
